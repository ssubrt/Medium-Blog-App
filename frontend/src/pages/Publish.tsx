    ...
    const clickhandler = async() =>{
     ...
     return (
         <div>
             ...
             focus:ring-blue-900 focus:border-blue-500 block w-full p-2"
                         placeholder="title" />

                         <TextEditor  onChange={(e)=>{
                            setDescription(e.target.value);
                         }}  />
                         <button onClick={clickhandler}  type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium 
    ...
    return <div className="mt-2">
         <div className="w-full mb-4 ">           
             ...
             <div className="my-2 bg-white rounded-b-lg w-full">
                ...
                <textarea rows={8} onChange={onChange} className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 pl-2" 
